...
function setup() {
	...
	box7=new Box(400,225,20,35)
	box6=new Box(380,225,20,35)
	box8=new Box(420,225,20,35)
	box9=new Box(410,195,20,35)
	box10=new Box(390,195,20,35)
	box11=new Box(400,160,20,35)
	box13=new Box(680,110,20,20)
	box12=new Box(660,110,20,20)
	box14=new Box(700,110,20,20)
	box15=new Box(670,90,20,20)
	box16=new Box(690,90,20,20)
	box17=new Box(680,70,20,20)
